// Web Audio API Synthesizer for standalone Sci-Fi Sound Effects
...
class SoundManager {
  ...
  public playCountdownTick(isFinal: boolean = false) {
    ...
    try {
      ...
      osc.frequency.exponentialRampToValueAtTime(isFinal ? 1320 : 660, now + 0.1);
  ...
  public playChemicalFizz() {
    ...
    try {
      const now = this.ctx.currentTime;
      // Synthesize noise/fizz with buffer
